...
public class ProfessorController {
    ...
    public Professor createProfessor(@RequestBody Professor professor) {
        ...
        try {
           EmailDTO emailDTO = new EmailDTO("romenildo@gmail.com", "Professor Criado", "Professor foi criado com sucesso");
    ...
    public Professor updateProfessor(@PathVariable("id") Long id, @RequestBody Professor professor) {
        ...
        try {
           EmailDTO emailDTO = new EmailDTO("romenildo@gmail.com", "Professor Editado", "O professor foi editado com sucesso");
            String json = new ObjectMapper().writeValueAsString(emailDTO);
            Message message = MessageBuilder.withBody(json.getBytes())
                    .setContentType(MessageProperties.CONTENT_TYPE_JSON)
                    .build();
